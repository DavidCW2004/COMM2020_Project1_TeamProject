...
from message_board.models import Activity, Room, SessionSummary, Post, Agent
...
def _forbidden(detail: str = "Facilitator access required."):
    return Response({"detail": detail}, status=status.HTTP_403_FORBIDDEN)


# Allows facilitators to create/edit/delete activities
class FacilitatorActivityViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        if not _is_privileged(request.user):
            return _forbidden("Facilitator access required.")
