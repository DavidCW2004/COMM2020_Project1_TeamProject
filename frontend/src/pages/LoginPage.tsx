...
type LoginRole = "learner" | "facilitator";
...
export default function LoginPage() {
    ...
    }, [disabled, displayName, role, navigate]);
    ...
    const dotClass = (isSelected: boolean) =>
        ["h-4 w-4 rounded-full border transition", isSelected ? "bg-primary border-primary" : "bg-background border-border"].join(" ");
        ...
        <div className="min-h-screen bg-gradient-to-b from-primary/10 via-muted/40 to-background text-foreground px-4 py-10">
            <div className="mx-auto w-full max-w-2xl space-y-6">
                <div className="rounded-lg border border-border bg-background/80 backdrop-blur p-6 text-center space-y-2 shadow-sm">
                    <h1 className="text-2xl font-semibold tracking-tight">Social Study Teammates</h1>
                ...
                <div className="rounded-lg border border-border bg-background p-6 shadow-sm">
                    <div className="space-y-6">
                        ...
                        <details className="text-xs text-muted-foreground">
                            <summary className="cursor-pointer select-none opacity-80">Data & privacy</summary>
